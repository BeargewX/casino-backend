...
const PAY = {
  // ออกง่าย ได้น้อย — คืนเงินบางส่วนเท่านั้น
  skull:   { 3:0.08, 4:0.2,  5:0.5  },
  shield:  { 3:0.12, 4:0.35, 5:0.9  },
  sword:   { 3:0.18, 4:0.5,  5:1.4  },
  // กลาง
  coin:    { 3:0.4,  4:1.2,  5:3.5  },
  fire:    { 3:0.7,  4:2.5,  5:7.0  },
  // ออกยาก ได้เยอะ
  gem:     { 3:2.0,  4:8.0,  5:25   },
  dragon:  { 3:5.0,  4:20,   5:50   }, // Wild — หายากมาก
}
